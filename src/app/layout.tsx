...
export const metadata: Metadata = {
  title: "FALAB",
  description:
    "패션 산업에 특화된 AI 도구 카탈로그 및 커뮤니티 허브",
};
  ...
  return (
    ...
    >
      ...
      <body className="min-h-full flex flex-col font-sans">
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-50 focus:rounded-lg focus:bg-foreground focus:px-4 focus:py-2 focus:text-background focus:text-sm focus:font-medium"
        >
          본문으로 건너뛰기
        </a>
        <Providers>
